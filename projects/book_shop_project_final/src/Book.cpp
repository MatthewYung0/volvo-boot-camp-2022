#include "Book.h"
    ...
    Book::Book() = default;
    Book::Book(std::string author_name, std::string title_name, std::string publisher_name, float price, int number_of_copies) : author_name(author_name), title_name(title_name), publisher_name(publisher_name), price(price), number_of_copies(number_of_copies){};
    Book::~Book(){};
